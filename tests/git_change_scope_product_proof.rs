...
fn git_change_scope_matrix_is_deterministic_private_and_non_mutating() {
    ...
    let evaluation = json!({
        ...
        "edge_case_evidence": {
            ...
            "stderr_bound": "git::tests::real_process_output_limits_and_stderr_are_closed",
            "reader_bound": "git::tests::the_bounded_reader_keeps_the_limit_and_reports_the_byte_past_it",
            "call_stage": "git::tests::every_outcome_is_reported_at_the_stage_of_its_call",
