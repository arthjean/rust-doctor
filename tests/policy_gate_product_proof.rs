...
fn seven_rule_policy_matrix_is_deterministic_private_and_non_mutating() {
    ...
    assert_eq!(default["schema_version"], 18);
    ...
    let producer_off_policies = [
        (
            ...
            vec![
                "--rule",
                "clippy::absurd_extreme_comparisons=off",
                "--rule",
                "clippy::almost_swapped=off",
                "--rule",
                "clippy::approx_constant=off",
                "--rule",
                "clippy::arc_with_non_send_sync=off",
                "--rule",
                "clippy::async_yields_async=off",
                "--rule",
                "clippy::await_holding_lock=off",
                "--rule",
                "clippy::await_holding_refcell_ref=off",
                "--rule",
                "clippy::bad_bit_mask=off",
                "--rule",
                "clippy::cast_slice_different_sizes=off",
                "--rule",
                "clippy::char_indices_as_byte_indices=off",
                "--rule",
                "clippy::dbg_macro=off",
                "--rule",
                "clippy::deprecated_semver=off",
                "--rule",
                "clippy::derive_ord_xor_partial_ord=off",
                "--rule",
                "clippy::derived_hash_with_manual_eq=off",
                "--rule",
                "clippy::eager_transmute=off",
                "--rule",
                "clippy::enum_clike_unportable_variant=off",
                "--rule",
                "clippy::eq_op=off",
                "--rule",
                "clippy::erasing_op=off",
                "--rule",
                "clippy::exit=off",
                "--rule",
                ...
                "--rule",
                "clippy::if_let_mutex=off",
                "--rule",
                "clippy::ifs_same_cond=off",
                "--rule",
                "clippy::impl_hash_borrow_with_str_and_bytes=off",
                "--rule",
                "clippy::impossible_comparisons=off",
                "--rule",
                "clippy::indexing_slicing=off",
                "--rule",
                "clippy::ineffective_bit_mask=off",
                "--rule",
                "clippy::infinite_iter=off",
                "--rule",
                "clippy::inherent_to_string_shadow_display=off",
                "--rule",
                "clippy::inline_fn_without_body=off",
                "--rule",
                "clippy::inverted_saturating_sub=off",
                "--rule",
                "clippy::invisible_characters=off",
                "--rule",
                "clippy::iter_next_loop=off",
                "--rule",
                "clippy::iter_skip_zero=off",
                "--rule",
                "clippy::iterator_step_by_zero=off",
                "--rule",
                "clippy::large_types_passed_by_value=off",
                "--rule",
                "clippy::lint_groups_priority=off",
                "--rule",
                "clippy::manual_memcpy=off",
                "--rule",
                "clippy::match_str_case_mismatch=off",
                "--rule",
                "clippy::mem_forget=off",
                "--rule",
                "clippy::mem_replace_with_uninit=off",
                "--rule",
                "clippy::min_max=off",
                "--rule",
                "clippy::missing_safety_doc=off",
                "--rule",
                "clippy::mistyped_literal_suffixes=off",
                "--rule",
                "clippy::modulo_one=off",
                "--rule",
                "clippy::mut_from_ref=off",
                "--rule",
                "clippy::mut_mutex_lock=off",
                "--rule",
                "clippy::never_loop=off",
                "--rule",
                "clippy::non_octal_unix_permissions=off",
                "--rule",
                "clippy::non_send_fields_in_send_ty=off",
                "--rule",
                "clippy::nonsensical_open_options=off",
                "--rule",
                "clippy::not_unsafe_ptr_arg_deref=off",
                "--rule",
                "clippy::option_env_unwrap=off",
                "--rule",
                "clippy::out_of_bounds_indexing=off",
                "--rule",
                "clippy::panic=off",
                "--rule",
                "clippy::panic_in_result_fn=off",
                "--rule",
                "clippy::panicking_overflow_checks=off",
                "--rule",
                "clippy::panicking_unwrap=off",
                "--rule",
                "clippy::permissions_set_readonly_false=off",
                "--rule",
                "clippy::possible_missing_comma=off",
                "--rule",
                ...
                "clippy::rc_mutex=off",
                "--rule",
                "clippy::read_line_without_trim=off",
                "--rule",
                "clippy::recursive_format_impl=off",
                "--rule",
                "clippy::redundant_allocation=off",
                "--rule",
                "clippy::redundant_comparisons=off",
                "--rule",
                "clippy::reversed_empty_ranges=off",
                "--rule",
                "clippy::self_assignment=off",
                "--rule",
                "clippy::size_of_in_element_count=off",
                "--rule",
                ...
                "--rule",
                "clippy::suspicious_splitn=off",
                "--rule",
                "clippy::todo=off",
                "--rule",
                "clippy::too_many_arguments=off",
                "--rule",
                "clippy::transmute_null_to_fn=off",
                "--rule",
                "clippy::transmuting_null=off",
                "--rule",
                "clippy::type_complexity=off",
                "--rule",
                "clippy::unimplemented=off",
                "--rule",
                "clippy::uninit_assumed_init=off",
                "--rule",
                "clippy::uninit_vec=off",
                "--rule",
                "clippy::unit_cmp=off",
                "--rule",
                "clippy::unit_hash=off",
                "--rule",
                "clippy::unit_return_expecting_ord=off",
                "--rule",
                "clippy::unnecessary_to_owned=off",
                "--rule",
                "clippy::unreachable=off",
                "--rule",
                "clippy::unsound_collection_transmute=off",
                "--rule",
                "clippy::unused_async=off",
                "--rule",
                "clippy::unused_io_amount=off",
                "--rule",
                "clippy::unwrap_used=off",
                "--rule",
                "clippy::useless_attribute=off",
                "--rule",
                "clippy::useless_vec=off",
                "--rule",
                "clippy::vec_init_then_push=off",
                "--rule",
                "clippy::vec_resize_to_zero=off",
                "--rule",
                "clippy::while_immutable_condition=off",
                "--rule",
                "clippy::wrong_transmute=off",
                "--rule",
                "clippy::zombie_processes=off",
                "--rule",
                "clippy::zst_offset=off",
            ],
        ),
        (
            "cargo-health",
