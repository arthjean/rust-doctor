...
| `--category CATEGORY` | Scan only a specific diagnostic category (e.g. `performance`, `security`, `error-handling`). Bypasses unrelated and slow analysis passes for speed |
